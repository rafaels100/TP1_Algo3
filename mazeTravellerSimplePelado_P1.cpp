...
void mazeSimple(int n, int m, int contador, bool orientacion){
  cantLlamadas++;
  if (n == 0 and m == 0) {
    cantPosibles++;
  ...
  if (m == 0 and orientacion == 0) {
    mazeSimple(n - 1, m, contador + 1, 1);
  }
  else if(m == cols - 1 and orientacion == 0 and contador != 0) {
    mazeSimple(n - 1, m, contador + 1, 1);
  }
  else if(n == cols - 1 and orientacion == 1 and contador != 0) {
    mazeSimple(n, m - 1, contador + 1, 0);
  }
  else if(n == 0 and orientacion == 1) {
    mazeSimple(n, m - 1, contador + 1, 0);
  }
  else {
    mazeSimple(n, m - 1, contador + 1, 0);
